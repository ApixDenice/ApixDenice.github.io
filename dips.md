...
<div class="app-page">
  ...
  <div class="app-content">
    <section class="feature-section reveal">
      <h2>What is DIPS?</h2>
      <p>DIPS is a social fitness app that connects you with sport events happening near you. Instead of training alone, open a live map, see what's on around you, and join real sessions — running, cycling, bouldering, calisthenics and more. Want to lead? Host your own event in seconds and let the local community find it.</p>
    </section>
    ...
    <section class="feature-section reveal">
      ...
      <div class="features-grid">
        <div class="feature-card">
          ...
          <h3>Live event map</h3>
          <p>See sport events around you in real time, clustered by area and filtered by activity.</p>
        </div>
        <div class="feature-card">
          <div class="feature-icon">➕</div>
          <h3>Host in seconds</h3>
          <p>Create an event with a sport, place, date, time and group size — and watch people join.</p>
        </div>
        <div class="feature-card">
          <div class="feature-icon">🤝</div>
          <h3>Train together</h3>
          <p>Join sessions, meet training partners, and build your local fitness community.</p>
        </div>
        <div class="feature-card">
          <div class="feature-icon">📅</div>
          <h3>Your events</h3>
          <p>Track the events you host and the ones you've joined, all in one place.</p>
        </div>
      </div>
    </section>
    ...
    <section class="feature-section feature-section-compact reveal">
      <h2>Built with</h2>
      <p>DIPS is a native iOS app written in <strong>Swift</strong> and <strong>SwiftUI</strong>, with a real-time <strong>Firebase</strong> backend powering the live event map and your account.</p>
    </section>
