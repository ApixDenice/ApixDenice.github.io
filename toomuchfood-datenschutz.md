...
<div class="privacy-policy-page">
  <div class="privacy-header">
    ...
    <p class="last-updated">Stand: 16. September 2026</p>
  ...
  <div class="privacy-content">
    ...
    <section class="privacy-section">
      ...
      <div class="contact-details">
        ...
        38268 Lengede<br>
        Deutschland</p>
        <p>E-Mail: <a href="mailto:{{ site.email }}" class="privacy-email-link">{{ site.email }}</a><br>
    ...
    <section class="privacy-section">
      <h2>3. Datenverarbeitung durch Werbung (Google AdMob)</h2>
      <p>Zur Anzeige von Werbung setzen wir das Google Mobile Ads SDK (AdMob) der Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland, ein.</p>
      <p>Google kann dabei folgende Daten verarbeiten:</p>
      <ul>
        <li><strong>Gerätekennungen</strong>, insbesondere die Werbekennung (IDFA) sowie Kennungen auf Geräteebene</li>
        <li><strong>Ungefährer Standort</strong>, abgeleitet aus Ihrer IP-Adresse — einen genauen Standort fragen wir nicht ab, die App hat darauf keinen Zugriff</li>
        <li><strong>Nutzungsdaten</strong>, etwa Interaktionen mit Werbeanzeigen und für die Werbeauslieferung relevante Ereignisse in der App</li>
        <li><strong>Diagnosedaten</strong>, etwa Absturzberichte und Leistungsmessungen</li>
        <li><strong>Technische Informationen</strong>, etwa IP-Adresse, Betriebssystemversion, Gerätemodell und Spracheinstellungen</li>
      </ul>
    ...
    <section class="privacy-section">
      <h2>5. Herausforderungs-Links („Ghost Duels“)</h2>
      <p>Nach einer Runde können Sie auf <strong>CHALLENGE</strong> tippen, um eine Freundin oder einen Freund zu einem Rennen gegen Ihre Runde einzuladen. Ein Link wird nur erzeugt, wenn Sie diese Schaltfläche antippen, und er erreicht nur die Personen, denen Sie ihn über eine App oder einen Dienst Ihrer Wahl (zum Beispiel Nachrichten oder WhatsApp) selbst senden.</p>
      <p>Der Link enthält:</p>
      <ul>
        <li>Ihren Punktestand und den Strecken-Seed dieser Runde</li>
        <li>die aufgezeichnete Bewegung Ihrer Spielfigur in dieser Runde (den „Geist“), ohne Datum oder Uhrzeit</li>
        <li>den ausgewählten Charakter-Skin</li>
        <li>Ihren Game-Center-Nickname, sofern Sie bei Game Center angemeldet sind; andernfalls den neutralen Namen „A FRIEND“</li>
      </ul>
      <p>Wir erhalten diese Daten nicht, speichern sie nicht und haben keinen Zugriff darauf. Der Link wird auf Ihrem Gerät erzeugt und ausschließlich von Ihnen weitergegeben. Die App der empfangenden Person liest die Herausforderung aus dem Link und speichert sie nur auf deren Gerät, bis sie gewonnen, abgelehnt oder nach drei Tagen verfallen ist. Wenn Ihr Nickname nicht enthalten sein soll, melden Sie sich vor dem Senden bei Game Center ab oder verzichten Sie auf das Senden.</p>
      <p>Öffnet die empfangende Person den Link ohne installierte App, wird eine Landingpage auf dieser Website geladen. Die Website wird von GitHub, Inc., 88 Colin P. Kelly Jr. Street, San Francisco, CA 94107, USA (GitHub Pages) gehostet. Beim Aufruf verarbeitet GitHub technische Daten wie IP-Adresse, Browserinformationen und die aufgerufene Adresse — einschließlich der im Link enthaltenen Herausforderungsdaten —, um die Seite auszuliefern und den Dienst abzusichern. Die Seite liest die Herausforderung im Browser aus und sendet nichts an uns. Eine Verarbeitung in den USA ist möglich; die von GitHub genutzten Garantien sind in dessen <a href="https://docs.github.com/site-policy/privacy-policies/github-general-privacy-statement" rel="noopener" target="_blank">Datenschutzerklärung</a> beschrieben.</p>
    </section>
    ...
    <section class="privacy-section">
      ...
      <ul>
        ...
        <li><strong>Tracking (IDFA):</strong> iOS-Einstellungen ▸ Datenschutz &amp; Sicherheit ▸ Tracking ▸ Too Much Food.</li>
        <li><strong>Bestenliste:</strong> in der App unter Einstellungen ▸ Leaderboard.</li>
      </ul>
    ...
    <section class="privacy-section">
      ...
      <ul>
        ...
        <li><strong>Widerspruch</strong> gegen eine Verarbeitung auf Grundlage berechtigter Interessen (Art. 21)</li>
        <li><strong>Widerruf</strong> einer erteilten Einwilligung (Art. 7 Abs. 3)</li>
      </ul>
    ...
    <div class="privacy-footer">
      <a href="{{ '/toomuchfood/' | relative_url }}" class="btn btn-outline">← Zurück zu Too Much Food</a>
    </div>
